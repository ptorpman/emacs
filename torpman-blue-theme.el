...
(custom-theme-set-faces
 ...
 '(font-lock-builtin-face ((t (:bold nil :foreground "wheat"))))
 '(font-lock-comment-face ((t (:bold nil :foreground "gray72"))))
 '(font-lock-comment-delimeter-face ((t (:bold nil :foreground "gray72"))))
 '(font-lock-constant-face ((t (:bold nil :foreground "cyan3"))))
 '(font-lock-doc-string-face ((t (:foreground "#00C000"))))
 '(font-lock-function-name-face ((t (:bold nil :foreground "chartreuse"))))
 '(font-lock-keyword-face ((t (:bold nil :foreground "gold1"))))
 '(font-lock-other-emphasized-face ((t (:bold nil :foreground "gold1"))))
 '(font-lock-other-type-face ((t (:bold nil :foreground "gold1"))))
 '(font-lock-preprocessor-face ((t (:foreground "plum"))))
 '(font-lock-reference-face ((t (:bold nil :foreground "orangered"))))
 '(font-lock-string-face ((t (:foreground "light blue"))))
 '(font-lock-type-face ((t (:bold nil :foreground "gold1"))))
